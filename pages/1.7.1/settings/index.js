...
chrome.storage.sync.get(["globalTheme"], function (r) {
  ...
  if (rr) {
    ...
    vue.theme = true;
    vue.themePath = "/images/scratch-addons/moon.svg";
  } else {
    vue.theme = false;
    vue.themePath = "/images/scratch-addons/theme.svg";
  }
});
...
const vue = (window.vue = new Vue({
  ...
  data: {
    ...
    theme: "",
    themePath: "",
    switchPath: "/images/scratch-addons/switch.svg",
    isOpen: false,
  ...
  methods: {
    ...
    sidebarToggle: function () {
      ...
      if (this.categoryOpen) {
        vue.switchPath = "/images/scratch-addons/close.svg";
      } else {
        vue.switchPath = "/images/scratch-addons/switch.svg";
      }
    },
    msg(message, ...params) {
    ...
    textParse(text, addon) {
      ...
      return text.replace(regex, (icon) => {
        ...
        if (icon[0] === "@") {
          return `<img class="inline-icon" src="/images/scratch-addons/${icon.split("@")[1]}"/>`;
        }
        if (icon[0] === "#") {
