...
const popups = [
  {
    ...
    icon: "/images/scratch-addons/envelope.svg",
  ...
  {
    addonId: "cloud-games",
    icon: "/images/scratch-addons/cloud.svg",
...
for (const popup of popups) {
  ...
  if (popup.fullscreen) {
    ...
    img.src = "/images/scratch-addons/popout.svg";
...
function setPopup(popup) {
  currentPopup = popup;
  document.getElementById("iframe").src = `../${popup.url}`;
