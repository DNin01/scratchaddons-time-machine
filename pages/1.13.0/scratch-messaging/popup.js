  ...
  const vue = new Vue({
    ...
    methods: {
      ...
      projectLoversAndFavers(project) {
        ...
        arr.forEach((obj, i) => {
          if (obj.loved) str += `<img class="small-icon colored" src="/images/scratch-addons/heart.svg">`;
          if (obj.faved) str += `<img class="small-icon colored" src="/images/scratch-addons/star.svg">`;
          str += " ";
